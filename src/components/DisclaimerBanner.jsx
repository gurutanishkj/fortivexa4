  ...
  return (
    <div className="bg-navy-900 border-b border-cyan-900/60 px-4 py-2 flex flex-col md:flex-row items-center justify-between text-xs text-slate-300 gap-2 shadow-inner">
      <div className="flex items-center gap-2">
        <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-emerald-950/80 border border-emerald-500/50 text-emerald-300 font-mono font-semibold tracking-wider text-[11px]">
          <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
          FORTIVEXA | TRL 5 VALIDATED PROTOTYPE
        </span>
